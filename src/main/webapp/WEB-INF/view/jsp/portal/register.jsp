...
<div class="user-wrap">
    <div class="user-con w">
        ...
        <div class="user-box">
            ...
            <form id="signupForm" method="POST" action="./user/register.do">
                <div class="user-item">
                ...
                <div class="user-item">
                    ...
                    <input type="password" class="user-content" name="password" id="password" placeholder="输入密码"/>
                </div>
                <div class="user-item">
                    <label class="user-label" for="password_confirm"><i class="fa fa-lock"></i></label>
                    <input type="password" class="user-content" name="password_confirm" id="password_confirm" placeholder="再次输入密码"/>
                </div>
                <div class="user-item">
                    <label class="user-label" for="phone"><i class="fa fa-phone"></i></label>
                    <input type="text" class="user-content" name="phone" id="phone" placeholder="输入电话" autocomplete="off"/>
                </div>
                <div class="user-item">
                    <label class="user-label" for="email"><i class="fa fa-envelope"></i></label>
                    <input type="text" class="user-content" name="email" id="email" placeholder="输入邮箱" autocomplete="off"/>
                </div>
                <div class="user-item">
                    <label class="user-label" for="question"><i class="fa fa-question"></i></label>
                    <input type="text" class="user-content" name="question" id="question" placeholder="输入密码提示问题" autocomplete="off"/>
                </div>
                <div class="user-item">
                    <label class="user-label" for="answer"><i class="fa fa-key"></i></label>
                    <input type="text" class="user-content" name="answer" id="answer" placeholder="输入密码提示答案" autocomplete="off"/>
                </div>
               <input class="user-btn" type="submit" id="submit" value="立即注册" />
                </fieldset>
            </form>
            <div class="link-item">
