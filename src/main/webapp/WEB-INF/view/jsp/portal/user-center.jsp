    ...
    <div class="right-con">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="user-info">
                    <div class="text-line"><span class="text-label">用户名：</span> <span class="text">${res.data.username}</span></div>
                    <div class="text-line"><span class="text-label">电 话：</span> <span class="text">${res.data.phone}</span>
                    </div>
                    <div class="text-line"><span class="text-label">邮 箱：</span> <span
                            class="text">${res.data.email}</span></div>
                    <div class="text-line"><span class="text-label">问 题：</span> <span class="text">${res.data.question}</span></div>
                    <div class="text-line"><span class="text-label">答 案：</span> <span class="text">${res.data.answer}</span></div>
                    <div class="text-line"><a href="./user-info-update.do" class="btn btn-mini btn-submit">编辑</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="../../../../js/user-center.js"></script>
</body>
</html>