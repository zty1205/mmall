...
<body>
<div class=header-simple> <div class=w> <a href=../product/index.do class=logo>MMall</a> </div> </div>
<div class="result-wrap w">
    <%--<input type="hidden" id="status" value="${RESULT}" />--%>
    <div class="<c:if test='${RESULT != 2}'>result-con</c:if> register-success">
        <h1 class="result-title">恭喜您，注册成功！</h1>
        <p class="result-content">
            <a class="link" href="./goLogin.do">立即去登录</a>
        </p>
    </div>
    ...
    <div class="<c:if test='${RESULT != 0}'>result-con</c:if>">
    ...
    <div class="result-con payment-success">
        ...
        <p class="result-content">
            <a class="link" href="../product/index.do">继续购物</a>
            <a class="link my-order" href="../order-detail.do?orderNo=">查看我的订单</a>
        </p>
    </div>
