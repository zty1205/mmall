...
<head>
    ...
    <link href="../../../../css/user-info-update.css" rel="stylesheet">
</head>
<body>
<div class=site-nav>
    <div class=w>
...
<div class="pass-update-wrap w">
    <div class="left-con">
        <ul class="menu">
            <li class="menu-item active"><a class="link" href="../user/get_userInfo.do">个人中心</a></li>
    ...
    <div class="right-con">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="user-info">
                    <div class="text-line"><span class="text-label">用户名：</span> <span class="input">${res.data.username}</span></div>
                    <div class="text-line"><span class="text-label">电 话：</span> <input type="text" class="input"
                                                                                       id="phone" autocomplete="off"
                                                                                       value="${res.data.phone}"></div>
                    <div class="text-line"><span class="text-label">邮 箱：</span> <input type="text" class="input"
                                                                                       id="email" autocomplete="off"
                                                                                       value="${res.data.email}"></div>
                    <div class="text-line"><span class="text-label">问 题：</span> <input type="text" class="input"
                                                                                       id="question" autocomplete="off"
                                                                                       value="${res.data.question}"></div>
                    <div class="text-line"><span class="text-label">答 案：</span> <input type="text" class="input"
                                                                                       id="answer" autocomplete="off"
                                                                                       value="${res.data.answer}"></div>
                    <div class="text-line"><span class="btn btn-mini btn-submit">提交修改</span></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="../../../../js/user-info-update.js"></script>
</body>
</html>